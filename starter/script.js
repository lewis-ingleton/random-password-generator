...
function getPasswordOptions() {
  ...
  passwordLength = prompt("Choose your password length between 10 and 64 characters.");
...
// Empty array to store random characters generated by getRandom() function 
let randomCharsArr = [];
...
function getRandom(arr) {
  ...
  let randomChar = arr[rnd];


  randomCharsArr.push(randomChar);
  console.log("randomChars Array:", randomCharsArr);
...
// CS - TODO:
// CS - Inside gerenatePassword() Perform the getRandom() function x amount of times, where x is equal to the passwordLength. If we perform the function x amount of times, we should recieve x amount of random characters that are pushed to the randomCharsArr. (Try writing a loop to call the function getRandom(possibleCharacters) x amount of times. )
// CS - Then, determine which array method you can use on the array to join together all of the characters to make one new string?
// CS - return the string and then you should see the generated string to the text box when the "generate password" button is clicked.

// Function to generate password with user input
function generatePassword() {

  // CS - TODO: write loop here:
}
